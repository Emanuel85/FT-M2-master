...
document.querySelector('#createdBy').innerHTML='Aplicación creada por Emanuel'
...
toDoShell.className="toDoShell"  //toDoShell.classList.add ('toDoShell') classList es otra alternativa para agregar una clase a una etiqueta
                                 //primero accedemos al metodo classlist y luego accedemos a una de sus propiedades en este caso add que asigna
